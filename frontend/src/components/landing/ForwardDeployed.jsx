...
const pillars = [
  {
    ...
    copy:
      "A senior forward-deployed engineer, a finance architect and an ops lead work alongside your team, on Slack, on calls, on-site when it matters.",
  },
  {
    icon: Workflow,
  ...
  },
  {
    ...
    copy:
      "Once pipelines are live, FinBoard runs them for you, refreshing reports and dashboards in real time as data lands from every source.",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-10 lg:py-12">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-[14px] text-[#0A0A0A]/70 leading-relaxed">
              FinBoard isn&apos;t a form you fill in and hope. We embed engineers with your finance and ops leaders to design the pipelines, dashboards and reviews that match how <em>your</em> group actually operates, from day one and every quarter after.
            </p>
